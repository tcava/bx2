...
#define DEFAULT_CDCC_PROMPT NULL
...
#define DEFAULT_CTOOLZ_DIR NULL
...
#define DEFAULT_DEFAULT_MENU NULL
#define DEFAULT_DEFAULT_NICK NULL
#define DEFAULT_DEFAULT_REASON NULL
...
#define DEFAULT_FAKE_SPLIT_PATTERNS NULL
/* XXX Make bx's default match epic's. */
...
#define DEFAULT_MSGLOG_FILE NULL
...
#define DEFAULT_SERVER_PROMPT NULL
...
#define DEFAULT_SHOW_NUMERICS_STR NULL
...
#define DEFAULT_STATUS_CDCCCOUNT NULL
...
#define DEFAULT_STATUS_DCCCOUNT NULL
#define DEFAULT_STATUS_FLAG NULL
...
#define DEFAULT_STATUS_FORMAT3 NULL
...
#define DEFAULT_STATUS_LAG NULL
#define DEFAULT_STATUS_MAIL " (Mail: %M)"
#define DEFAULT_STATUS_MODE " (+%+)"
#define DEFAULT_STATUS_MSGCOUNT NULL
...
#define DEFAULT_STATUS_OPER_KILLS NULL
...
#define DEFAULT_STATUS_TOPIC NULL
