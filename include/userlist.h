...
Nick *check_auto (char *, Nick *, Channel *);
int check_prot (char *, char *, Channel *, BanList *, Nick *);
void check_shit (Channel *);
void check_hack (char *, Channel *, Nick *, char *);
