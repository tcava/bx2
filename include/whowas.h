...
typedef struct _whowas_str {
	...
	char	*server1;
	char	*server2;
	Nick	*nicklist;	/* pointer to nicklist */
...
void add_to_whowas_buffer (Nick *, char *, char *, char *);
void add_to_whosplitin_buffer (Nick *, char *, char *, char *);
...
void add_to_whowas_chan_buffer (Channel *);
