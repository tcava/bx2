...
#define DEFAULT_FORMAT_WHOIS_ACTUALLY_FSET ansi?"%K: %Wa%nctually : $0 is from $1":":^B a^Bctually : $0 is from $1"
...
#define DEFAULT_STATUS_FORMAT " [0;44;36m[[1;37m%T[0;44;36m][%*%@%G%=[0;44;37m%N%#%A[0;44;36m]%M [0;44;36m[%C%+%W[0;44;36m] %Q %H%B%F "
